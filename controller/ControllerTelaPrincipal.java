...
public class ControllerTelaPrincipal implements Initializable {
  ...
  @FXML
  private ComboBox<String> comboBoxCodificacao, comboBoxEnquadramento, comboBoxErro;
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    //Insere as opcoes de codificacao, de enquadramento e de probabilidade de erro nas ComboBoxes
